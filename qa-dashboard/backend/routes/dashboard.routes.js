...
const cache2min = (req, res, next) => { res.set('Cache-Control', 'private, max-age=120'); next(); };
const cache5min = (req, res, next) => { res.set('Cache-Control', 'private, max-age=300'); next(); };
